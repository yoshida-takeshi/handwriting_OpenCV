...
for VectData0 in VectData:
    ...
    for VectData1 in VectData0:
        ...
        if (f==11): (r,g,b)=(255, 63, 63)
        if (f==12): (r,g,b)=(255,127,127)
        if (f==13): (r,g,b)=(255,191,191)
        if (f==20): (r,g,b)=(  0,255,  0)
        if (f==21): (r,g,b)=( 63,255, 63)
        if (f==22): (r,g,b)=(127,255,127)
        if (f==23): (r,g,b)=(191,255,191)
        if (f==30): (r,g,b)=(  0,  0,255)
        if (f==31): (r,g,b)=( 63, 63,255)
        if (f==32): (r,g,b)=(127,127,255)
        if (f==33): (r,g,b)=(191,191,255)
        if (f==40): (r,g,b)=(255,255,  0)
        if (f==41): (r,g,b)=(255,255, 63)
        if (f==42): (r,g,b)=(255,255,127)
        if (f==43): (r,g,b)=(255,255,191)
        if (f==50): (r,g,b)=(255,  0,255)
        if (f==51): (r,g,b)=(255, 63,255)
        if (f==52): (r,g,b)=(255,127,255)
        if (f==53): (r,g,b)=(255,191,255)
        if (f==60): (r,g,b)=(  0,255,255)
        if (f==61): (r,g,b)=( 63,255,255)
        if (f==62): (r,g,b)=(127,255,255)
        if (f==63): (r,g,b)=(191,255,255)
        Color=(b, g, r)
        print((n0,n1),(x,y),f)
